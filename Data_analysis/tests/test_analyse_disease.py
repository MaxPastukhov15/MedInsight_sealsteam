...
from analyse_disease import analyse_disease, load_data, normalize_id
...
class TestAnalyseDisease:
    ...
    def sample_patients(self):
        ...
        return pd.DataFrame({
            ...
            'birth_date_raw': ['01/01/1980', '15/06/1995', '20/03/1970', '10/10/2000', '05/05/1985'],
            'gender': ['М', 'Ж', 'М', 'Ж', 'М'],
    ...
    def test_analyse_disease_no_disease_provided(self, sample_diagnoses, sample_prescriptions, sample_patients):
        """Test that error is returned when neither disease_code nor disease_name is provided"""
    ...
    def test_analyse_disease_invalid_disease_name(self, sample_diagnoses, sample_prescriptions, sample_patients):
        """Test that error is returned for non-existent disease name"""
        result_json, status = analyse_disease(
            year=2023,
            diagnoses=sample_diagnoses,
            prescriptions=sample_prescriptions,
...
class TestLoadData:
    ...
    def test_load_data_missing_file(self):
        """Test 4: load_data raises FileNotFoundError when a data file is missing"""
        # Mock the paths to point to a non-existent directory
        with patch('analyse_disease.os.path.dirname') as mock_dirname:
    ...
    @patch('analyse_disease.pd.read_parquet')
...
class TestNormalizeId:
    ...
    def test_normalize_id_integers(self):
        """Test 5a: normalize_id correctly cleans integer patient IDs"""
    ...
    def test_normalize_id_floats(self):
        """Test 5b: normalize_id correctly removes .0 from float patient IDs"""
    ...
    def test_normalize_id_strings_with_whitespace(self):
        """Test 5c: normalize_id correctly strips whitespace from string patient IDs"""
    ...
    def test_normalize_id_mixed_formats(self):
        """Test 5d: normalize_id handles mixed formats (integers, floats, strings)"""
    ...
    def test_normalize_id_strings_without_decimal(self):
        """Test 5e: normalize_id preserves string IDs that don't end with .0"""
    ...
    def test_normalize_id_empty_series(self):
        """Test 5f: normalize_id handles empty series"""
