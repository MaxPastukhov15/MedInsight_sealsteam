...
def analyse_disease(
    ...
    sex_distribution = {"M": round(gender_counts.get("М", 0) * 100, 2), "F": round(gender_counts.get("Ж", 0) * 100, 2)}
    ...
    top_districts = [{"name": name, "count": int(count)} for name, count in top_dist_series.items()]
    ...
    result = {
        ...
        "demographics": {
            ...
            "age_stats": {"mean": round(mean_age, 2), "median": round(median_age, 2)},
